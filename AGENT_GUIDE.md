...
| **Add a keyboard shortcut** | `App.tsx` (onKeyDown), `terminal-input.ts` | `App.tsx` | `tauri:dev` manual test |
...
| **Add multi-tab / split** | `App.tsx`, `main.rs`, `tauri.conf.json` | Major refactor | `tauri:dev` |
