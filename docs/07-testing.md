...
| `parses_terminal_launch_arguments` / `routes_existing_local_documents_to_the_browser` / `treats_a_directory_as_shell_working_directory` / `rejects_a_missing_working_directory` | Launch parsing | Command arguments, local document, directory and invalid working-directory cases |
