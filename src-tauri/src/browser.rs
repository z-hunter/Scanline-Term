...
fn browser_shortcut(url: &url::Url, session_id: &str) -> Option<String> {
    ...
    matches!(code, "KeyS" | "KeyA" | "KeyB" | "KeyV" | "KeyC" | "KeyN" | "KeyW" | "PageUp" | "PageDown" | "Digit1" | "Digit2" | "Digit3" | "Digit4" | "Digit5" | "Digit6" | "Digit7" | "Digit8" | "Digit9" | "ArrowRight" | "ArrowLeft" | "Period" | "Comma" | "Tab").then(|| code.to_owned())
}
